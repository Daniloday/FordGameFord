...
import com.missclick.fordgame.databinding.FragmentGameTwoBinding
...
class GameTwoFragment : Fragment() {
    val viewModel : GameTwoViewModel by viewModel()
    val bind by viewBinding(FragmentGameTwoBinding::bind)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.append(score = "player")
        bind.materialButtonLose.setOnClickListener {
            findNavController().navigate(R.id.action_gameTwoFragment_to_loseFragment)
        }
        bind.materialButtonWin.setOnClickListener {
            findNavController().navigate(R.id.action_gameTwoFragment_to_gameThreeFragment)
        }
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment GameTwoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GameTwoFragment().apply {
